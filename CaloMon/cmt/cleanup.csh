...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=CaloMon -version=CaloMon-00-00-00 -path=/users/hpcusers/dumpCaloCells  $* >${cmtCaloMontempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=CaloMon -version=CaloMon-00-00-00 -path=/users/hpcusers/dumpCaloCells  $* >${cmtCaloMontempfile}"
